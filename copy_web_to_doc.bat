xcopy /S/Y web\s1\s1.* docs
xcopy /S/Y web\s1\res docs\res

xcopy /S/Y web\s2\s2.* docs
xcopy /S/Y web\s2\res docs\res

xcopy /S/Y web\s3\s3.* docs
xcopy /S/Y web\s3\res docs\res
...
xcopy /S/Y web\s13\s13.* docs
xcopy /S/Y web\s13\res docs\res

xcopy /S/Y web\s14\s14.* docs
xcopy /S/Y web\s14\res docs\res

xcopy /S/Y web\s15\s15.* docs
xcopy /S/Y web\s15\res docs\res

xcopy /S/Y web\s16\s16.* docs
xcopy /S/Y web\s16\res docs\res
...
xcopy /S/Y web\s24\s24.* docs
xcopy /S/Y web\s24\res docs\res

xcopy /S/Y web\s25\s25.* docs
xcopy /S/Y web\s25\res docs\res

xcopy /S/Y web\s26\s26.* docs
xcopy /S/Y web\s26\res docs\res
