...
var Ha = 0,
  ...
  Ka = [];
function La() {
  if (navigator.userActivation ? navigator.userActivation.isActive : Ja && Ma.Na) for (var a = 0; a < Ka.length; ++a) {
    var b = Ka[a];
    Ka.splice(a, 1);
    --a;
    b.Ya(...b.Sa);
...
function Oa(a) {
  ...
  if (a.Fa) a.Ha = function (c) {
    ...
    La();
    --Ja;
  }, a.target.addEventListener(a.xa, a.Ha, a.Ea), O.push(a);else for (var b = 0; b < O.length; ++b) O[b].target == a.target && O[b].xa == a.xa && Na(b--);
  return 0;
}
var Ma,
  Pa,
...
var Y,
  ub = {
    ...
    M: (a, b, c, d) => Ta(a, b, c, d, 2, "keydown"),
    L: (a, b, c, d) => Ta(a, b, c, d, 3, "keyup"),
    oa: (a, b, c, d) => Ua(a, b, c, d, 5, "mousedown"),
    ma: (a, b, c, d) => Ua(a, b, c, d, 8, "mousemove"),
    na: (a, b, c, d) => Ua(a, b, c, d, 6, "mouseup"),
  ...
  Za = a => (Za = Z.sa)(a),
  R = a => (R = Z.ta)(a),
  vb = g._main = (a, b) => (vb = g._main = Z.va)(a, b),
  wb;
F = function xb() {
  wb || yb();
  wb || (F = xb);
