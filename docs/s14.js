...
var Ia = 0,
  ...
  La = [];
function Ma() {
  if (navigator.userActivation ? navigator.userActivation.isActive : Ka && Na.Na) for (var a = 0; a < La.length; ++a) {
    var b = La[a];
    La.splice(a, 1);
    --a;
    b.Ya(...b.Sa);
...
function Oa(a) {
  var b = N[a];
  b.target.removeEventListener(b.xa, b.Ha, b.Ea);
  N.splice(a, 1);
}
function Pa(a) {
  if (!a.target) return -4;
  if (a.Fa) a.Ha = function (c) {
    ++Ka;
    Na = a;
    Ma();
    a.Ia(c);
    Ma();
    --Ka;
  }, a.target.addEventListener(a.xa, a.Ha, a.Ea), N.push(a);else for (var b = 0; b < N.length; ++b) N[b].target == a.target && N[b].xa == a.xa && Oa(b--);
  return 0;
}
var Na,
  Qa,
  ...
  Va = (a, b, c, d, f, k) => {
    ...
    return Pa({
      target: a,
      Na: "mousemove" != k && "mouseenter" != k && "mouseleave" != k,
      xa: k,
      Fa: d,
      Ia: function () {
...
var eb = 1,
  ...
  mb = (a, b) => {
    a.wa || (a.wa = a.getContext, a.getContext = function (d, f) {
      f = a.wa(d, f);
  ...
  rb = a => {
    var b = Y.Oa,
      c = b.ya[a];
    "number" == typeof c && (b.ya[a] = c = Y.getUniformLocation(b, b.Ja[a] + (0 < c ? `[${c}]` : "")));
    return c;
  };
R = new Xa();
va();
...
var Y,
  sb = {
    ...
    M: (a, b, c, d) => Ua(a, b, c, d, 2, "keydown"),
    L: (a, b, c, d) => Ua(a, b, c, d, 3, "keyup"),
    oa: (a, b, c, d) => Va(a, b, c, d, 5, "mousedown"),
    ma: (a, b, c, d) => Va(a, b, c, d, 8, "mousemove"),
    na: (a, b, c, d) => Va(a, b, c, d, 6, "mouseup"),
    ...
    ka: (a, b) => {
      ...
      a = Ta(a);
      return !a || b.Pa ? 0 : mb(a, b);
    },
    ja: a => {
      var _nb;
      nb = ib[a];
      g.Ta = Y = (_nb = nb) === null || _nb === void 0 ? void 0 : _nb.Ma;
      return !a || Y ? 0 : -5;
    },
    x: (a, b, c, d) => {
    ...
    j: a => Y.blendEquation(a),
    k: (a, b) => Y.blendFunc(a, b),
    i: (a, b, c, d) => {
      c && b ? Y.bufferData(a, w, d, c, b) : Y.bufferData(a, b, d);
    },
    y: a => Y.clear(a),
    z: (a, b, c, d) => Y.clearColor(a, b, c, d),
    aa: a => {
      Y.compileShader(X[a]);
    },
    fa: () => {
    ...
    r: (a, b) => {
      for (var c = 0; c < a; c++) {
        var d = y[b + 4 * c >> 2],
          f = fb[d];
        f && (Y.deleteBuffer(f), f.name = 0, fb[d] = null, d == Y.Ga && (Y.Ga = 0), d == Y.Ca && (Y.Ca = 0));
      }
    },
    C: (a, b) => {
      for (var c = 0; c < a; ++c) {
    ...
    E: (a, b, c) => {
      if (c && !(a >= eb)) if (a = V[a], 35716 == b) y[c >> 2] = Y.getProgramInfoLog(a).length + 1;else if (35719 == b) {
        if (!a.Ba) for (b = 0; b < Y.getProgramParameter(a, 35718); ++b) a.Ba = Math.max(a.Ba, Y.getActiveUniform(a, b).name.length + 1);
        y[c >> 2] = a.Ba;
      } else if (35722 == b) {
        if (!a.za) for (b = 0; b < Y.getProgramParameter(a, 35721); ++b) a.za = Math.max(a.za, Y.getActiveAttrib(a, b).name.length + 1);
        y[c >> 2] = a.za;
      } else if (35381 == b) {
        if (!a.Aa) for (b = 0; b < Y.getProgramParameter(a, 35382); ++b) a.Aa = Math.max(a.Aa, Y.getActiveUniformBlockName(a, b).length + 1);
        y[c >> 2] = a.Aa;
    ...
    u: (a, b) => {
      ...
      if (a = V[a]) {
        var c = a,
          ...
          f = c.Ka,
          k;
        if (!d) for (c.ya = d = {}, c.Ja = {}, k = 0; k < Y.getProgramParameter(c, 35718); ++k) {
        ...
        if ((f = a.Ka[f]) && d < f[0] && (d += f[1], c[d] = c[d] || Y.getUniformLocation(a, b))) return d;
      }
      return -1;
    },
    ea: a => {
    ...
    V: (a, b, c, d) => Y.scissor(a, b, c, d),
    ba: (a, b, c, d) => {
      for (var f = "", k = 0; k < b; ++k) f += G(A[c + 4 * k >> 2], d ? A[d + 4 * k >> 2] : void 0);
      Y.shaderSource(X[a], f);
    },
    B: (a, b, c, d, f, k, e, m, h) => {
      if (Y.Ca) Y.texImage2D(a, b, c, d, f, k, e, m, h);else if (h) {
        var r = m - 5120;
  ...
  Za = a => (Za = Z.sa)(a),
  Q = a => (Q = Z.ta)(a),
  tb = g._main = (a, b) => (tb = g._main = Z.va)(a, b),
  ub;
E = function vb() {
  ub || wb();
  ub || (E = vb);
