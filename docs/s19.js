...
var ASM_CONSTS = {
  ...
  21154: () => navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined,
  21258: () => {
    try {
  ...
  24257: $0 => miniaudio.get_device_by_index($0).webaudio.sampleRate,
  24323: $0 => {
...
var wasmImports = {
  ...
  ha: _upload_unicode_char_to_texture
};
