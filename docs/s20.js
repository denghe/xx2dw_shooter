...
var Y,
  ub = {
    ...
    la: (a, b, c, d) => Ta(a, b, c, d, 2, "keydown"),
    ka: (a, b, c, d) => Ta(a, b, c, d, 3, "keyup"),
    ja: (a, b, c, d) => Ua(a, b, c, d, 5, "mousedown"),
    ha: (a, b, c, d) => Ua(a, b, c, d, 8, "mousemove"),
    ia: (a, b, c, d) => Ua(a, b, c, d, 6, "mouseup"),
    ...
    k: a => Y.blendEquation(a),
    l: (a, b) => Y.blendFunc(a, b),
    p: (a, b, c, d) => {
    ...
    j: (a, b) => Y.getAttribLocation(V[a], M(b)),
    Z: (a, b, c, d) => {
