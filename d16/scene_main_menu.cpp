...
void SceneMainMenu::Init() {
	...
	rootNode->MakeChildren<Label>()->Init(3, { 0, 100 }, { 2, 2 }, { 0.5f, 0.5f }, RGBA8_White, U"control: Z X ASDW + mouse left button ");

	rootNode->MakeChildren<Button>()->Init(3, { 0, 0 }, { 0.5f, 0.5f }, gLooper.s9cfg_btn, U"New Game", [&]() {
