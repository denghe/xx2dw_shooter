#pragma once
#ifndef XX2DW_SHOOTER_D4_PCH_H_
#define XX2DW_SHOOTER_D4_PCH_H_
...
constexpr XYi gGridBasePos{ gGridCellDiameter * gGridNumCols / 2, gGridCellDiameter * gGridNumRows / 2 };
