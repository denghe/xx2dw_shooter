...
xx::Task<> GameLooper::MainTask() {
	...
	root->MakeChildren<Button>()->Init(0, basePos + XY{ -50, 0 }, anchor, cfg, U"A");
	root->MakeChildren<Button>()->Init(0, basePos + XY{ 0, 0 }, anchor, cfg, U"S");
	root->MakeChildren<Button>()->Init(0, basePos + XY{ 50, 0 }, anchor, cfg, U"D");
	root->MakeChildren<Button>()->Init(0, basePos + XY{ 150, 0 }, anchor, cfg, U"J");
	kct.Emplace();
	ready = true;
	co_return;
}
